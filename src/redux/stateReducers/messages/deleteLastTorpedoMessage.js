import { DELETELASTTORPEDOMESSAGE } from "../../actionTypes";
...
const deleteLastTorpedoMessage = (
  state = getInitStateFromStorage("deleteLastTorpedoMessage", initialState),
  action
) => {
  switch (action.type) {
    case DELETELASTTORPEDOMESSAGE.SUCCESS:
      return { ...initialState };
    default:
      return state;
  }
