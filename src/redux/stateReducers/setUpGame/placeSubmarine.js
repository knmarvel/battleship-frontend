import { PLACESUBMARINE } from "../../actionTypes";
...
const placeSubmarine = (
  state = getInitStateFromStorage("placeSubmarine", initialState),
  action
) => {
  switch (action.type) {
    case PLACESUBMARINE.SUCCESS:
      return { ...initialState };
    default:
      return state;
  }
...
export default withAsyncReducer(PLACESUBMARINE, placeSubmarine);
